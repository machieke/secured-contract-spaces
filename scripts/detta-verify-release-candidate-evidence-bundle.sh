...
require_inventory_bundle_path "reports/detta-da-incident-response-drill-${version}.json"
...
require_inventory_bundle_path "reports/detta-da-stability-drill-${version}.json"
